...
#define MAP_FORTREE_CITY     (6 | (0 << 8))
#define MAP_LILYCOVE_CITY    (7 | (0 << 8))
#define MAP_MOSSDEEP_CITY    (8 | (0 << 8))
#define MAP_SOOTOPOLIS_CITY  (9 | (0 << 8))
#define MAP_EVER_GRANDE_CITY (10 | (0 << 8))
