...
const u16 DecorGfx_RHYDON_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_RHYDON_DOLL
};
...
const u16 DecorGfx_VENUSAUR_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_VENUSAUR_DOLL
};

const u16 DecorGfx_CHARIZARD_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_CHARIZARD_DOLL
};

const u16 DecorGfx_BLASTOISE_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_BLASTOISE_DOLL
};

const u16 DecorGfx_WAILMER_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_WAILMER_DOLL
};

const u16 DecorGfx_REGIROCK_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_REGIROCK_DOLL
};

const u16 DecorGfx_REGICE_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_REGICE_DOLL
};

const u16 DecorGfx_REGISTEEL_DOLL[] = {
    EVENT_OBJ_GFX_ZBIG_REGISTEEL_DOLL
};
