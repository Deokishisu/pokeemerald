...
const u8 gDeadBerryTreeEventObjectGraphicsIdTable[] = {EVENT_OBJ_GFX_ZBERRY_TREE_EARLY_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_EARLY_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_EARLY_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_EARLY_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_EARLY_STAGES};

const u8 gBerryTreeEventObjectGraphicsIdTable[] = {EVENT_OBJ_GFX_ZBERRY_TREE_EARLY_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_EARLY_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_LATE_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_LATE_STAGES, EVENT_OBJ_GFX_ZBERRY_TREE_LATE_STAGES};
