...
{
    {EVENT_OBJ_GFX_ZRIVAL_BRENDAN_NORMAL,     EVENT_OBJ_GFX_ZRIVAL_MAY_NORMAL},
    {EVENT_OBJ_GFX_ZRIVAL_BRENDAN_MACH_BIKE,  EVENT_OBJ_GFX_ZRIVAL_MAY_MACH_BIKE},
    {EVENT_OBJ_GFX_ZRIVAL_BRENDAN_ACRO_BIKE,  EVENT_OBJ_GFX_ZRIVAL_MAY_ACRO_BIKE},
    {EVENT_OBJ_GFX_ZRIVAL_BRENDAN_SURFING,    EVENT_OBJ_GFX_ZRIVAL_MAY_SURFING},
    {EVENT_OBJ_GFX_ZBRENDAN_UNDERWATER,       EVENT_OBJ_GFX_ZMAY_UNDERWATER},
    {EVENT_OBJ_GFX_ZRIVAL_BRENDAN_FIELD_MOVE, EVENT_OBJ_GFX_ZRIVAL_MAY_FIELD_MOVE},
    {EVENT_OBJ_GFX_BRENDAN_FISHING,          EVENT_OBJ_GFX_MAY_FISHING},
    {EVENT_OBJ_GFX_ZBRENDAN_WATERING,         EVENT_OBJ_GFX_ZMAY_WATERING}
};

static const u8 sPlayerAvatarGfxIds[][2] =
{
    {EVENT_OBJ_GFX_GOLD_NORMAL,     EVENT_OBJ_GFX_KRIS_NORMAL},
    {EVENT_OBJ_GFX_GOLD_MACH_BIKE,  EVENT_OBJ_GFX_KRIS_MACH_BIKE},
    {EVENT_OBJ_GFX_ZBRENDAN_ACRO_BIKE,  EVENT_OBJ_GFX_ZMAY_ACRO_BIKE},
    {EVENT_OBJ_GFX_ZBRENDAN_SURFING,    EVENT_OBJ_GFX_ZMAY_SURFING},
    {EVENT_OBJ_GFX_ZBRENDAN_UNDERWATER, EVENT_OBJ_GFX_ZMAY_UNDERWATER},
    {EVENT_OBJ_GFX_ZBRENDAN_FIELD_MOVE, EVENT_OBJ_GFX_ZMAY_FIELD_MOVE},
    {EVENT_OBJ_GFX_BRENDAN_FISHING,    EVENT_OBJ_GFX_MAY_FISHING},
    {EVENT_OBJ_GFX_ZBRENDAN_WATERING,   EVENT_OBJ_GFX_ZMAY_WATERING},
};
...
static const u8 gUnknown_0849750C[2][5][2] =
{
    //male
    {
        {EVENT_OBJ_GFX_GOLD_NORMAL, 1},
        {EVENT_OBJ_GFX_GOLD_MACH_BIKE, 2},
        {EVENT_OBJ_GFX_ZBRENDAN_ACRO_BIKE, 4},
        {EVENT_OBJ_GFX_ZBRENDAN_SURFING, 8},
        {EVENT_OBJ_GFX_ZBRENDAN_UNDERWATER, 16},
    },
    //female
    {
        {EVENT_OBJ_GFX_KRIS_NORMAL, 1},
        {EVENT_OBJ_GFX_KRIS_MACH_BIKE, 2},
        {EVENT_OBJ_GFX_ZMAY_ACRO_BIKE, 4},
        {EVENT_OBJ_GFX_ZMAY_SURFING, 8},
        {EVENT_OBJ_GFX_ZMAY_UNDERWATER, 16},
    }
};
...
u8 unref_GetRivalAvatarGenderByGraphicsId(u8 gfxId)
{
    ...
    case EVENT_OBJ_GFX_ZRIVAL_MAY_MACH_BIKE:
    case EVENT_OBJ_GFX_ZRIVAL_MAY_ACRO_BIKE:
    case EVENT_OBJ_GFX_ZRIVAL_MAY_SURFING:
    case EVENT_OBJ_GFX_ZRIVAL_MAY_FIELD_MOVE:
    case EVENT_OBJ_GFX_ZMAY_UNDERWATER:
    case EVENT_OBJ_GFX_MAY_FISHING:
    case EVENT_OBJ_GFX_ZMAY_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
...
u8 GetPlayerAvatarGenderByGraphicsId(u8 gfxId)
{
    switch (gfxId)
    {
    case EVENT_OBJ_GFX_KRIS_NORMAL:
    case EVENT_OBJ_GFX_KRIS_MACH_BIKE:
    case EVENT_OBJ_GFX_ZMAY_ACRO_BIKE:
    case EVENT_OBJ_GFX_ZMAY_SURFING:
    case EVENT_OBJ_GFX_ZMAY_FIELD_MOVE:
    case EVENT_OBJ_GFX_ZMAY_UNDERWATER:
    case EVENT_OBJ_GFX_MAY_FISHING:
    case EVENT_OBJ_GFX_ZMAY_WATERING:
        return FEMALE;
