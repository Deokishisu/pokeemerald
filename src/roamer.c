...
{
    { MAP_NUM(ROUTE38), MAP_NUM(ROUTE39), MAP_NUM(ROUTE45), MAP_NUM(ROUTE46), 0xFF, 0xFF },
    ...
    { MAP_NUM(RUINS_OF_ALPH_EXTERIOR), MAP_NUM(ROUTE23), MAP_NUM(LAKE_OF_RAGE), 0xFF, 0xFF, 0xFF },
    { MAP_NUM(LAKE_OF_RAGE), MAP_NUM(RUINS_OF_ALPH_EXTERIOR), 0xFF, 0xFF, 0xFF, 0xFF },
    { 0xFF, MAP_NUM(RUINS_OF_ALPH_EXTERIOR), 0xFF, 0xFF, 0xFF, 0xFF },
