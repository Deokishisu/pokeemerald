...
{
    EVENT_OBJ_GFX_ZHIKER,
    EVENT_OBJ_GFX_ZTUBER_M,
    EVENT_OBJ_GFX_COOLTRAINER_M,
    EVENT_OBJ_GFX_ZRICH_BOY,
    EVENT_OBJ_GFX_SUPER_NERD,
    EVENT_OBJ_GFX_ZRUNNING_TRIATHLETE_M,
    EVENT_OBJ_GFX_BLACK_BELT,
    EVENT_OBJ_GFX_ZMAN_5,
    EVENT_OBJ_GFX_ZMAN_5,
    EVENT_OBJ_GFX_ZCAMPER,
    EVENT_OBJ_GFX_SUPER_NERD,
    EVENT_OBJ_GFX_ZPSYCHIC_M,
    EVENT_OBJ_GFX_GENTLEMAN,
    EVENT_OBJ_GFX_ZSCHOOL_KID_M,
    EVENT_OBJ_GFX_POKEFAN_M,
    EVENT_OBJ_GFX_OLD_MAN,
    EVENT_OBJ_GFX_YOUNGSTER,
    EVENT_OBJ_GFX_ZFISHERMAN,
    EVENT_OBJ_GFX_BIKER,
    EVENT_OBJ_GFX_ZRUNNING_TRIATHLETE_M,
    EVENT_OBJ_GFX_ZRUNNING_TRIATHLETE_M,
    EVENT_OBJ_GFX_COOLTRAINER_M,
    EVENT_OBJ_GFX_ZMAN_5,
    EVENT_OBJ_GFX_ZNINJA_BOY,
    EVENT_OBJ_GFX_SAILOR,
    EVENT_OBJ_GFX_SUPER_NERD,
    EVENT_OBJ_GFX_ZMAN_4,
    EVENT_OBJ_GFX_ZCAMPER,
...
{
    EVENT_OBJ_GFX_ZWOMAN_2,
    EVENT_OBJ_GFX_ZTUBER_F,
    EVENT_OBJ_GFX_COOLTRAINER_F,
    EVENT_OBJ_GFX_OLD_WOMAN,
    EVENT_OBJ_GFX_ZWOMAN_2,
    EVENT_OBJ_GFX_BEAUTY,
    EVENT_OBJ_GFX_LASS,
    EVENT_OBJ_GFX_ZGIRL_3,
    EVENT_OBJ_GFX_POKEFAN_F,
    EVENT_OBJ_GFX_TEACHER,
    EVENT_OBJ_GFX_ZCYCLING_TRIATHLETE_F,
    EVENT_OBJ_GFX_ZRUNNING_TRIATHLETE_F,
    EVENT_OBJ_GFX_ZRUNNING_TRIATHLETE_F,
    EVENT_OBJ_GFX_ZGIRL_3,
    EVENT_OBJ_GFX_COOLTRAINER_F,
    EVENT_OBJ_GFX_ZRUNNING_TRIATHLETE_F,
    EVENT_OBJ_GFX_ZPICNICKER,
    EVENT_OBJ_GFX_ZWOMAN_2,
    EVENT_OBJ_GFX_ZPICNICKER,
    EVENT_OBJ_GFX_LASS
};
