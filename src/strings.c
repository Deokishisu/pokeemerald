...
const u8 gText_GSCTrainerCardName[] = _("NAME/");
const u8 gText_TrainerCardBadgesArrow[] = _("BADGES▶");
...
const u8 gText_TrainerCardPlayTime[] = _("PLAY TIME");
const u8 gText_TrainerCardColon[] = _("{TRAINER_CARD_COLON}");
