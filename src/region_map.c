...
static const u8 sMapHealLocations[][3] = {
    {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), HEAL_LOCATION_NEW_BARK_TOWN_PLAYERS_HOUSE_2F},
    ...
    {MAP_GROUP(NONE), MAP_NUM(NONE), HEAL_LOCATION_LAVARIDGE_TOWN},
    ...
    {MAP_GROUP(NONE), MAP_NUM(NONE), HEAL_LOCATION_PACIFIDLOG_TOWN},
    ...
    {MAP_GROUP(NONE), MAP_NUM(NONE), HEAL_LOCATION_LILYCOVE_CITY},
    {MAP_GROUP(NONE), MAP_NUM(NONE), HEAL_LOCATION_MOSSDEEP_CITY},
    {MAP_GROUP(NONE), MAP_NUM(NONE), HEAL_LOCATION_SOOTOPOLIS_CITY},
    {MAP_GROUP(NONE), MAP_NUM(NONE), HEAL_LOCATION_EVER_GRANDE_CITY_1},
    ...
    {MAP_GROUP(ROUTE23), MAP_NUM(ROUTE23), 0},
    {MAP_GROUP(ROUTE28), MAP_NUM(ROUTE28), 0},
    {MAP_GROUP(SILVER_CAVE_EXTERIOR), MAP_NUM(SILVER_CAVE_EXTERIOR), 0},
    {MAP_GROUP(RUINS_OF_ALPH_EXTERIOR), MAP_NUM(RUINS_OF_ALPH_EXTERIOR), 0},
    {MAP_GROUP(LAKE_OF_RAGE), MAP_NUM(LAKE_OF_RAGE), 0},
};
