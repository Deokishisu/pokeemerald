...
{
    [FRONTIER_FACILITY_TOWER]   = {EVENT_OBJ_GFX_ZANABEL,  TRUE},
	[FRONTIER_FACILITY_DOME]    = {EVENT_OBJ_GFX_ZTUCKER,  FALSE},
	[FRONTIER_FACILITY_PALACE]  = {EVENT_OBJ_GFX_ZSPENSER, FALSE},
	[FRONTIER_FACILITY_ARENA]   = {EVENT_OBJ_GFX_ZGRETA,   TRUE},
	[FRONTIER_FACILITY_FACTORY] = {EVENT_OBJ_GFX_ZNOLAND,  FALSE},
	[FRONTIER_FACILITY_PIKE]    = {EVENT_OBJ_GFX_ZLUCY,    TRUE},
	[FRONTIER_FACILITY_PYRAMID] = {EVENT_OBJ_GFX_ZBRANDON, FALSE},
};
